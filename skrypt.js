...
function myFunction() {
	...
	if (iloscMiejscPoPrzecinku != 0) {
		...
		var miejscaPoPrzecinkuSlownie = liczbyPoPrzecinkuSlownie(miejscaPoPrzecinku);
...
function liczbyPoPrzecinkuSlownie(czescSetna) {
	...
	if (czescSetna >= 11 && czescSetna <= 19) {
		...
		if (czescSetna1.length == 3) {
			czescSetnaSlownie = "tysięcznych";
		}
		if (czescSetna1.length == 4) {
			czescSetnaSlownie = "dziesięciotysięcznych";
		}
	}
	
	if (czescSetna1.length == 1) {
	...
	if (czescSetna == 2) {
		...
		if (czescSetna1.length == 2) {
			czescSetnaSlownie = "setne";
		}
		if (czescSetna1.length == 3) {
			czescSetnaSlownie = "tysięczne";
		}
		if (czescSetna1.length == 4) {
			czescSetnaSlownie = "dziesięciotysięczne";
		}
	}
	...
	if (czescSetna == 1) {
		...
		if (czescSetna1.length == 2) {
			czescSetnaSlownie = "setna";
		}
		if (czescSetna1.length == 3) {
			czescSetnaSlownie = "tysięczna";
		}
		if (czescSetna1.length == 4) {
			czescSetnaSlownie = "dziesięciotysięczna";
		}
	}
